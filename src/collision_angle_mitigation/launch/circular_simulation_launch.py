...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('collision_angle_mitigation')
    launch_dir = os.path.join(bringup_dir, 'launch')
    sim_dir = get_package_share_directory('collision_angle_mitigation')
    ...
    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(sim_dir, 'urdf', 'gz_circular_robot.sdf.xacro'),
