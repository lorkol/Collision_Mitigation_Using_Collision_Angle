...
#ifndef EMERGENCY_MPPI_CONTROLLER__MOTION_MODELS_HPP_
#define EMERGENCY_MPPI_CONTROLLER__MOTION_MODELS_HPP_
...
#include "emergency_mppi/models/constraints.hpp"
...
/**
 * @class emergency_mppi::MotionModel
...
public:
  /**
    * @brief Constructor for emergency_mppi::MotionModel
    */
  MotionModel() = default;

  /**
    * @brief Destructor for emergency_mppi::MotionModel
    */
...
/**
 * @class emergency_mppi::AckermannMotionModel
...
public:
  /**
    * @brief Constructor for emergency_mppi::AckermannMotionModel
    */
...
/**
 * @class emergency_mppi::DiffDriveMotionModel
...
public:
  /**
    * @brief Constructor for emergency_mppi::DiffDriveMotionModel
    */
...
/**
 * @class emergency_mppi::OmniMotionModel
...
public:
  /**
    * @brief Constructor for emergency_mppi::OmniMotionModel
    */
...
#endif  // EMERGENCY_MPPI_CONTROLLER__MOTION_MODELS_HPP_
