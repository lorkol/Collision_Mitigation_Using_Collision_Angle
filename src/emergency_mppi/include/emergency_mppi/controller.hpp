...
#ifndef EMERGENCY_MPPI_CONTROLLER__CONTROLLER_HPP_
#define EMERGENCY_MPPI_CONTROLLER__CONTROLLER_HPP_

#include <string>
#include <memory>

#include "emergency_mppi/tools/path_handler.hpp"
#include "emergency_mppi/optimizer.hpp"
...
/**
 * @class emergency_mppi::MPPIController
 * @brief Main plugin controller for  Emergency MPPI Controller
 */
class MPPIController : public nav2_core::Controller
{
public:
  /**
    * @brief Constructor for emergency_mppi::MPPIController
    */
...
#endif  // EMERGENCY_MPPI_CONTROLLER__CONTROLLER_HPP_