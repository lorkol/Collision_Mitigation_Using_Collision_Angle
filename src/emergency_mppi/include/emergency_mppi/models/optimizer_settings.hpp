...
#ifndef EMERGENCY_MPPI_CONTROLLER__MODELS__OPTIMIZER_SETTINGS_HPP_
#define EMERGENCY_MPPI_CONTROLLER__MODELS__OPTIMIZER_SETTINGS_HPP_

#include <cstddef>
#include "emergency_mppi/models/constraints.hpp"
namespace emergency_mppi::models
{

/**
 * @struct emergency_mppi::models::OptimizerSettings
...
#endif  // EMERGENCY_MPPI_CONTROLLER__MODELS__OPTIMIZER_SETTINGS_HPP_
