...
#ifndef EMERGENCY_MPPI_CONTROLLER__MODELS__STATE_HPP_
#define EMERGENCY_MPPI_CONTROLLER__MODELS__STATE_HPP_
...
/**
 * @struct emergency_mppi::models::State
...
#endif  // EMERGENCY_MPPI_CONTROLLER__MODELS__STATE_HPP_
