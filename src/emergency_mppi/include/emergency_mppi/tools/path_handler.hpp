...
#ifndef EMERGENCY_MPPI_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
#define EMERGENCY_MPPI_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
...
/**
 * @class emergency_mppi::PathHandler
...
public:
  /**
    * @brief Constructor for emergency_mppi::PathHandler
    */
  PathHandler() = default;

  /**
    * @brief Destructor for emergency_mppi::PathHandler
    */
  ~PathHandler() = default;
...
#endif  // EMERGENCY_MPPI_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
