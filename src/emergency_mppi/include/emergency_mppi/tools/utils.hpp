...
#ifndef EMERGENCY_MPPI_CONTROLLER__TOOLS__UTILS_HPP_
#define EMERGENCY_MPPI_CONTROLLER__TOOLS__UTILS_HPP_
...
namespace emergency_mppi::utils
{
...
inline void savitskyGolayFilter(
  ...
  std::array<emergency_mppi::models::Control, 4> & control_history,
...
#endif  // EMERGENCY_MPPI_CONTROLLER__TOOLS__UTILS_HPP_
