...
#ifndef EMERGENCY_MPPI_CONTROLLER__TOOLS__PARAMETERS_HANDLER_HPP_
#define EMERGENCY_MPPI_CONTROLLER__TOOLS__PARAMETERS_HANDLER_HPP_
...
/**
 * @class emergency_mppi::ParametersHandler
...
public:
  ...
  /**
    * @brief Constructor for emergency_mppi::ParametersHandler
    */
  ...
  /**
    * @brief Destructor for emergency_mppi::ParametersHandler
    */
  ~ParametersHandler();
...
#endif  // EMERGENCY_MPPI_CONTROLLER__TOOLS__PARAMETERS_HANDLER_HPP_
