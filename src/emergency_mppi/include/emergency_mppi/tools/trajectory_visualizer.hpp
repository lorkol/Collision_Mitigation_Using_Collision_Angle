...
#ifndef EMERGENCY_MPPI_CONTROLLER__TOOLS__TRAJECTORY_VISUALIZER_HPP_
#define EMERGENCY_MPPI_CONTROLLER__TOOLS__TRAJECTORY_VISUALIZER_HPP_
...
/**
 * @class emergency_mppi::TrajectoryVisualizer
...
public:
  /**
    * @brief Constructor for emergency_mppi::TrajectoryVisualizer
    */
...
#endif  // EMERGENCY_MPPI_CONTROLLER__TOOLS__TRAJECTORY_VISUALIZER_HPP_
