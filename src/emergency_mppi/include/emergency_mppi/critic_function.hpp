...
#ifndef EMERGENCY_MPPI_CONTROLLER__CRITIC_FUNCTION_HPP_
#define EMERGENCY_MPPI_CONTROLLER__CRITIC_FUNCTION_HPP_
...
/**
 * @class emergency_mppi::critics::CollisionCost
...
/**
 * @class emergency_mppi::critics::CriticFunction
...
public:
  /**
    * @brief Constructor for emergency_mppi::critics::CriticFunction
    */
  CriticFunction() = default;

  /**
    * @brief Destructor for emergency_mppi::critics::CriticFunction
    */
...
#endif  // EMERGENCY_MPPI_CONTROLLER__CRITIC_FUNCTION_HPP_