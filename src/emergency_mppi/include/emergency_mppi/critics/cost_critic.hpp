...
#ifndef EMERGENCY_MPPI_CONTROLLER__CRITICS__COST_CRITIC_HPP_
#define EMERGENCY_MPPI_CONTROLLER__CRITICS__COST_CRITIC_HPP_
...
/**
 * @class emergency_mppi::critics::CostCritic
...
#endif  // EMERGENCY_MPPI_CONTROLLER__CRITICS__COST_CRITIC_HPP_
