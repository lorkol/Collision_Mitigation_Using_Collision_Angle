...
#ifndef EMERGENCY_MPPI_CONTROLLER__OPTIMIZER_HPP_
#define EMERGENCY_MPPI_CONTROLLER__OPTIMIZER_HPP_
...
#include "emergency_mppi/motion_models.hpp"
#include "emergency_mppi/critic_manager.hpp"
#include "emergency_mppi/models/state.hpp"
#include "emergency_mppi/models/trajectories.hpp"
#include "emergency_mppi/models/path.hpp"
...
/**
 * @class emergency_mppi::Optimizer
...
public:
  /**
    * @brief Constructor for emergency_mppi::Optimizer
    */
  Optimizer() = default;

  /**
   * @brief Destructor for emergency_mppi::Optimizer
   */
  ~Optimizer() {shutdown();}
...
protected:
  ...
  std::array<emergency_mppi::models::Control, 4> control_history_;
...
#endif  // EMERGENCY_MPPI_CONTROLLER__OPTIMIZER_HPP_
